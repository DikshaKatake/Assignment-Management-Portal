...
--
-- Host: localhost
-- Generation Time: Jan 30, 2020 at 04:10 AM
...
(7, 89, 'WAP to display hello world', '', 5, 6, 1, 6, 3, '2019-05-14', '2019-05-28'),
(8, 99, 'WAP to print pattern', 'The pattern should be in trangular shape', 5, 6, 1, 6, 3, '2019-05-14', '2019-05-21'),
(9, 100, 'WAP to determine whether a year is leap.', 'program in Cpp', 5, 6, 1, 6, 3, '2019-05-14', '2019-05-21'),
(10, 102, 'WAP to print pattern.', 'Triangular pattern', 5, 6, 1, 6, 2, '2019-05-14', '2019-05-21'),
(11, 190, 'Diksha Katake', 'Diksha Katake', 5, 6, 1, 6, 2, '2019-07-24', '2019-07-27');
...
--
ALTER TABLE `assignments`
  MODIFY `assignment_id` int(3) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
